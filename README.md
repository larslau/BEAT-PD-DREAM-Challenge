...
This repository contains R code for reading the challenge data, generating features and for generating personalized prediction models for the patients in the challenge.
